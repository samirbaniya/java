...
public class DataPack {
	...
	public void SajiloPrepaid() {
		...
		if(userInput==1) {
			...
			System.out.println("You Have Choosed Utd-Combo@Rs999");
		}
		else if(userInput==4) {
			System.out.println("You Have Choosed Utd-Combo@Rs1499");
		}
		else if(userInput==5) {
			System.out.println("You Have Choosed Exec-Combo@Rs1999");
		}
		else {
	...
	public void ComboPacks() {
		System.out.println("Combo:Voice:AllNet:28D\n"
				+ "1)200Min+2GB@Rs199\n2)300Min+4GB+20SMS-NT@Rs299\n3)500Min+8GB+100SMS-ALLNet@Rs499");
		int userInput=scInt.nextInt();
		if(userInput==1) {
			...
			System.out.println("You Have Choosed 500Min+8GB+100SMS-ALLNet@Rs499");
		}
		else {
			System.out.println("You Have Choosed Invalid Choice.");
		}
	...
	public void NTToNT() {
		...
		int userInput=scInt.nextInt();
		if(userInput==1) {
			System.out.println("You Have Choosed 30Min@Rs18-1D.");
		}
		else if(userInput==2) {
			System.out.println("You Have Choosed 150Min@Rs59-1D.");
		}
		else if(userInput==3) {
	...
	public void AllNetwork() {
		...
		int userInput=scInt.nextInt();
		if(userInput==1) {
			System.out.println("You Have Choosed 30Min@Rs20-1D.");
		}
		else if(userInput==2) {
			System.out.println("You Have Choosed 150Min@Rs69-1D.");
		}
		else if(userInput==3) {
	...
	public void for4G() {
		...
		int userInput=scInt.nextInt();
		if(userInput==1) {
			System.out.println("You Have Choosed 1GB@Rs29-1D.");
		}
		else if(userInput==2) {
			System.out.println("You Have Choosed 3GB@Rs99-1D.");
		}
		else if(userInput==3) {
